...
# # --- 1. Top 10 Most Diverse Countries ---
# plt.figure(figsize=(10, 6))
# top_countries = (
#     df.groupby("country")["language"].count().sort_values(ascending=False).head(10)
# )
...
# # --- 2. Language Family Speaker Distribution ---
# plt.figure(figsize=(8, 8))
# family_data = df.groupby("family")["native_speakers"].sum().sort_values(ascending=False)
# plt.pie(
#     family_data,
...
# # --- 3. Identifying Cross-Border Languages ---
# cross_border = df.groupby("language")["country"].nunique()
# multi_nation = cross_border[cross_border > 1].sort_values(ascending=False).head(10)
# print("Top Cross-Border Languages:\n", multi_nation)


# --- Complex Logic 1: Speaker Density per Family ---
...
# --- Complex Logic 2: Cross-border Reach ---
...
# --- Complex Logic 3: Linguistic Concentration (Entropy-like) ---
...
sns.barplot(
    data=density_df.to_pandas(), x="speaker_density", y="family", palette="flare"
)
plt.title(
...
plt.figure(figsize=(12, 6))
sns.barplot(data=reach_df.to_pandas(), x="country_count", y="language", palette="crest")
plt.title(
    "Bridges of the Continent: Languages Spoken in Multiple Countries", fontsize=14
)
...
print("Density Data Sample:")
print(density_df.head())
print("\nReach Data Sample:")
print(reach_df.head())


# 2. Complex Logic: Diversity of Language Families per Country
...
# 3. Load Geographical Data
world = gpd.read_file("data/ne_110m_admin_0_countries.shp")
print(world.columns)
print(world.head())
africa = world[world["CONTINENT"] == "Africa"]

# 4. Join Polars Data with Map Data
